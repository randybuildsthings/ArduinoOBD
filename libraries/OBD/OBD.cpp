...
#define OBD_STRCPY strcpy_P
#define OBD_SPRINTF sprintf_P
#else
static const char s_initcmd[][MAX_CMD_LEN] = {"ATZ\r","ATE0\r","ATL1\r","0902\r"};
static const char s_cmd_fmt[] = "%02X%02X 1\r";
static const char s_cmd_sleep[] = "atlp\r";
#define OBD_STRCPY strcpy
#define OBD_SPRINTF sprintf
#endif
...
{
	char cmd[8];
	OBD_SPRINTF(cmd, s_cmd_fmt, dataMode, pid);
#ifdef DEBUG
	debugOutput(cmd);
#endif
	write(cmd);
